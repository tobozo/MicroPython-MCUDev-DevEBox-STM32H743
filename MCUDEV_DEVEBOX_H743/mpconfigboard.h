...
#define MICROPY_HW_BOARD_NAME       "MCUDEV_DEVEBOX_H743"
#define MICROPY_HW_MCU_NAME         "STM32H743VIT6"
#define MICROPY_HW_FLASH_FS_LABEL   "MCUDEV_DEVEBOX_H743"
...
#define MICROPY_BOARD_EARLY_INIT    MCUDEV_DEVEBOX_H743_board_early_init
void MCUDEV_DEVEBOX_H743_board_early_init(void);
...
// USRSW
#define MICROPY_HW_USRSW_PIN        (pin_E3) // K1 on the board.
#define MICROPY_HW_USRSW_PULL       (GPIO_NOPULL)
#define MICROPY_HW_USRSW_EXTI_MODE  (GPIO_MODE_IT_FALLING)
#define MICROPY_HW_USRSW_PRESSED    (0)

// LEDs
#define MICROPY_HW_LED1             (pin_A1) // D2, the only controlable LED on the board.
